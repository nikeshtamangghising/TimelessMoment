                    ...
                    {orders.data.map((order) => (
                      <tr key={order.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div>
                            <div className="text-sm font-medium text-gray-900">
                              {order.user ? order.user.name : order.guestName || 'Guest'}
                            </div>
                            <div className="text-sm text-gray-500">
                              {order.user ? order.user.email : order.guestEmail || 'No email'}
                            </div>
                            {order.isGuestOrder && (
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center space-x-2">
                            ...
                            <select
                              ...
                              className={`text-xs font-medium rounded-full px-2 py-1 border-0 focus:ring-2 focus:ring-indigo-500 ${getStatusColor(order.status)}`}
                            >
                              <option value="PENDING">Pending</option>
                              <option value="PROCESSING">Processing</option>
                              <option value="SHIPPED">Shipped</option>
